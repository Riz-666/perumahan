...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form class="form-horizontal" action="{{ route('cetak.data') }}" method="post"
                    target="_blank">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Role</label>
                            <select name="role" onkeypress="return hanyaAngka(event)" value="{{ old('role') }}" class="form-control @error('role') is-invalid @enderror" placeholder="Masukkan Jumlah Pinjam">
                                <option value=""></option>
